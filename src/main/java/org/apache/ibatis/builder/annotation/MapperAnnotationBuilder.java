...
private void loadXmlResource() {
  ...
  private Optional<AnnotationWrapper> getAnnotationWrapper(Method method, boolean errorIfNoMatch,
    ...
    // <1> databaseId 可以参考这篇文章 https://www.cnblogs.com/dgwblog/p/9571723.html
  ...
  private class AnnotationWrapper {
    ...
    // 是 select、insert、update、delete、SelectProvider、InsertProvider、UpdateProvider、DeleteProvider
    // tip：默认是 UNKNOWN 未知的
